        ...
        <div className="flex flex-col h-full">
          <div className="p-6 flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center overflow-hidden">
              <img
                src="/logo.png"
                alt="Steady Pocket Logo"
                className="w-full h-full object-cover"
              />
            </div>
            <span className="text-xl font-bold tracking-tight text-white flex-1">
              Steady Pocket
            </span>
            <button
              onClick={() => setIsSidebarOpen(false)}
            ...
            <div className="relative" ref={profileRef}>
              ...
              >
                <div className="text-right hidden sm:block px-1">
                  <p className="text-sm font-medium text-white group-hover:text-emerald-400 transition-colors uppercase tracking-tight">
                    {auth.currentUser?.email?.split("@")[0]}
                  </p>
                  <p className="text-[10px] text-neutral-500 uppercase tracking-widest leading-none mt-0.5">
                    Administrator
                  </p>
                </div>
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-6 lg:p-8 flex flex-col">
          ...
          <footer className="mt-12 py-8 border-t border-white/5 text-center">
            <p className="text-neutral-600 text-xs tracking-widest uppercase font-medium">
              &copy; {new Date().getFullYear()} Steady Pocket Platform • Built
              for Hackathon Demo •{" "}
